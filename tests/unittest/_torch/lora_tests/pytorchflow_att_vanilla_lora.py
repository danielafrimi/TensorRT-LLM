...
class TestLoraAttentionPytorchFlowVsVanilla(unittest.TestCase):
    ...
    def _run_pytorchflow_attention(self, attention_module, hidden_states,
    ...
    def test_attention_with_lora(self):
        ...
        # Run pytorchflow attention with LoRA
        pytorchflow_output = self._run_pytorchflow_attention(
            attention_module, hidden_states, attn_metadata, lora_params)
