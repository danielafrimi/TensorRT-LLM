...
class TestWeightOnlyGroupWiseQuantMatmul(unittest.TestCase):
    ...
    def _run_finegrained_mixed_dtype_gemm(self,
        ...
        print(f"alpha is {fp8_alpha.item()}")
    ...
    def test_prequant_matmul_fp8_int4_input(self, m, n, k, dtype, has_pre_quant,
                                            ...
                                            use_w4a8_awq):
        print(
            f"m: {m}, n: {n}, k: {k}, dtype: {dtype}, has_pre_quant: {has_pre_quant}, has_zero: {has_zero}, has_bias: {has_bias}, group_size: {group_size}, use_w4a8_awq: {use_w4a8_awq}"
        )
